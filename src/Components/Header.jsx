...
const Header = () => {
    return (
        <motion.div >
            ...
            <div className="border-b border-neutral-900 pb-10 pt-8">
                <div className="flex flex-wrap justify-evenly items-center">
                    ...
                    <div className="text-center max-w-2xl px-4">
                        ...
                        <motion.p initial={{x:200,opacity:0}} animate={{x:0,opacity:1,transition:{duration:1,delay:0.7}}} className="mt-2 text-xs sm:text-sm md:text-base tracking-tight">
            ...
            <div className="flex flex-wrap justify-center my-10 pt-7 px-4">
                <motion.p initial={{opacity:0,y:200}} animate={{y:0,opacity:1,transition:{duration:1,delay:1.3}}}  className="text-center text-2xl sm:text-3xl md:text-4xl lg:text-5xl max-w-6xl font-bold tracking-normal leading-tight">
                    International Conference on Sustainable Bio-Technologies and Innovations for a Hunger-Free World
